...
export default function ContactUs() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-500 to-blue-700 text-white py-20 text-center px-4">
        <h2 className="text-4xl md:text-5xl font-bold mb-4">Contact Us</h2>
        <p className="text-lg md:text-xl max-w-3xl mx-auto">
          Ready to start your construction project? Get in touch with our expert team for
        ...
        <div className="max-w-4xl mx-auto bg-white shadow-md p-8 rounded-md">
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              ></textarea>
              <p className="text-sm text-gray-400 mt-1">Maximum 500 characters</p>
            </div>
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          <div>
            <h3 className="text-2xl font-bold mb-4">Office Address</h3>
            ...
            <h4 className="text-lg font-semibold mt-6">Contact Details</h4>
            ...
            <a
              ...
              className="inline-block mt-6 bg-green-500 text-white px-5 py-3 rounded-md font-semibold hover:bg-green-600 transition"
            >
              Chat on WhatsApp
            </a>
          </div>
          ...
          {/* Google Map */}
          <div className="rounded overflow-hidden shadow-md h-[300px]">
            <iframe
              title="Google Map"
